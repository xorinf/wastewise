...
export function RecycleIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-.881 1.785 1.785 0 0 1-.004-1.784L7.19 9.5" />
      <path d="M11 19h8.2a1.8 1.8 0 0 0 1.576-.893 1.77 1.77 0 0 0 .013-1.777l-3.957-6.83" />
      <path d="m14 4.5 2.19 3.79" />
      <path d="M9.81 4.5 7.62 8.29" />
      <path d="M12 2.5 7.19 10.82" />
      <path d="m16.81 10.82-3.9 6.75" />
    </svg>
  );
}
